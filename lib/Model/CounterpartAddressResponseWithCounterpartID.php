...
/**
 * CounterpartAddressResponseWithCounterpartID Class Doc Comment
 *
 * @category Class
 ...
 */
class CounterpartAddressResponseWithCounterpartID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CounterpartAddressResponseWithCounterpartID';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique ID of the address in the system
     *
     * @return self
     */
     ...
     * Sets is_default
     *
     * @param bool $is_default True if address is the default address of the counterpart.
     *
     * @return self
     */
     ...
     * Sets counterpart_id
     *
     * @param string $counterpart_id ID of the counterpart that owns the address.
     *
     * @return self
     */
