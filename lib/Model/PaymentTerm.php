    ...
    */
    ...
    public function setNumberOfDays($number_of_days)
    {
        ...
        if (($number_of_days > 10000)) {
            throw new \InvalidArgumentException('invalid value for $number_of_days when calling PaymentTerm., must be smaller than or equal to 10000.');
        }
        if (($number_of_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $number_of_days when calling PaymentTerm., must be bigger than or equal to 0.');
        }
