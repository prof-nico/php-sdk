<?php
/**
 * EntityIndividualResponseAddress
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EntityIndividualResponseAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class EntityIndividualResponseAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntityIndividualResponse_address';
    ...
    */
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $city when calling EntityIndividualResponseAddress., must be smaller than or equal to 255.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling EntityIndividualResponseAddress., must be smaller than or equal to 10.');
        }
    ...
    public function setLine1($line1)
    {
        ...
        if ((mb_strlen($line1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling EntityIndividualResponseAddress., must be smaller than or equal to 255.');
        }
    ...
    public function setLine2($line2)
    {
        ...
        if ((mb_strlen($line2) > 100)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling EntityIndividualResponseAddress., must be smaller than or equal to 100.');
        }
