 ...
 */
class FileSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileSchema';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FileSchema., must be smaller than or equal to 512.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size < 0)) {
            throw new \InvalidArgumentException('invalid value for $size when calling FileSchema., must be bigger than or equal to 0.');
        }
