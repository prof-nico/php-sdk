...
/**
 * QuoteResponsePayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class QuoteResponsePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuoteResponsePayload';
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'status' => '\OpenAPI\Client\Model\QuoteStateEnum'
    ];
    ...
    */
    ...
    public function setQuoteAcceptPageUrl($quote_accept_page_url)
    {
        ...
        if ((mb_strlen($quote_accept_page_url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $quote_accept_page_url when calling QuoteResponsePayload., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($quote_accept_page_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $quote_accept_page_url when calling QuoteResponsePayload., must be bigger than or equal to 1.');
        }
    ...
    public function setCounterpartBusinessType($counterpart_business_type)
    {
        ...
        if ((mb_strlen($counterpart_business_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_business_type when calling QuoteResponsePayload., must be smaller than or equal to 50.');
        }
     ...
     * Sets comment
     *
     * @param string|null $comment Field with a comment on why the client declined this Quote
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\QuoteStateEnum
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\QuoteStateEnum $status status
     *
     * @return self
     */
