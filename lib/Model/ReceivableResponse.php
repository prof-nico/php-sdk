...
/**
 * ReceivableResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReceivableResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceivableResponse';
    ...
    protected static $openAPITypes = [
        ...
        'amount_due' => 'int',
        'payment_terms' => '\OpenAPI\Client\Model\PaymentTerms',
        'payment_reminder_id' => 'string',
        'overdue_reminder_id' => 'string',
        'recurrence_id' => 'string',
        'purchase_order' => 'string',
        'related_documents' => '\OpenAPI\Client\Model\InvoiceResponsePayloadRelatedDocuments'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'total_amount_with_credit_notes' => null,
        'amount_due' => null,
        'payment_terms' => null,
    ...
    protected static array $openAPINullables = [
		...
		'total_amount_with_credit_notes' => false,
		'amount_due' => false,
		'payment_terms' => false,
    ...
    protected static $setters = [
        ...
        'total_amount_with_credit_notes' => 'setTotalAmountWithCreditNotes',
    ...
    protected static $getters = [
        ...
        'total_amount_with_credit_notes' => 'getTotalAmountWithCreditNotes',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('total_amount_with_credit_notes', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_amount_with_credit_notes'] === null) {
            $invalidProperties[] = "'total_amount_with_credit_notes' can't be null";
        }
    ...
    public function setQuoteAcceptPageUrl($quote_accept_page_url)
    {
        ...
        if ((mb_strlen($quote_accept_page_url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $quote_accept_page_url when calling ReceivableResponse., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($quote_accept_page_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $quote_accept_page_url when calling ReceivableResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCounterpartBusinessType($counterpart_business_type)
    {
        ...
        if ((mb_strlen($counterpart_business_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_business_type when calling ReceivableResponse., must be smaller than or equal to 50.');
        }
     ...
     * Sets comment
     *
     * @param string|null $comment Field with a comment for pay/partially/uncollectible info on this Invoice
     *
     * @return self
     */
    ...
    /**
     * Gets total_amount_with_credit_notes
     *
     * @return int
     */
    public function getTotalAmountWithCreditNotes()
    {
        return $this->container['total_amount_with_credit_notes'];
    }

    /**
     * Sets total_amount_with_credit_notes
     *
     * @param int $total_amount_with_credit_notes The total price of the receivable in [minor units](https://docs.monite.com/docs/currencies#minor-units), including VAT and excluding all issued credit notes.
     *
     * @return self
     */
    public function setTotalAmountWithCreditNotes($total_amount_with_credit_notes)
    {
        if (is_null($total_amount_with_credit_notes)) {
            throw new \InvalidArgumentException('non-nullable total_amount_with_credit_notes cannot be null');
        }
        $this->container['total_amount_with_credit_notes'] = $total_amount_with_credit_notes;
     ...
     * Sets amount_due
     *
     * @param int $amount_due How much is left to be paid in [minor units](https://docs.monite.com/docs/currencies#minor-units). Equal 0 if the Invoice is fully paid.
     *
     * @return self
     */
     ...
     * Gets payment_terms
     *
     * @return \OpenAPI\Client\Model\PaymentTerms|null
     */
     ...
     * Sets payment_terms
     *
     * @param \OpenAPI\Client\Model\PaymentTerms|null $payment_terms payment_terms
     *
     * @return self
     */
     ...
     * Sets recurrence_id
     *
     * @param string|null $recurrence_id Stores an unique ID of a recurrence if the receivable is in a recurring status
     *
     * @return self
     */
    ...
    public function setPurchaseOrder($purchase_order)
    {
        ...
        if ((mb_strlen($purchase_order) > 100)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order when calling ReceivableResponse., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\InvoiceResponsePayloadRelatedDocuments
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InvoiceResponsePayloadRelatedDocuments $related_documents related_documents
     *
     * @return self
     */
