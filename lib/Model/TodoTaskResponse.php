...
/**
 * TodoTaskResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TodoTaskResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TodoTaskResponse';
    ...
    */
     ...
     * Sets related_object
     *
     * @param object|null $related_object Todo task is created on behalf of some specific object (e.g. payable) and references to its ID. This field contains information about the related object (e.g. payload PayableResponseSchema).
     *
     * @return self
     */
