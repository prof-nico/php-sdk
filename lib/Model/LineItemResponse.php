...
class LineItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payable_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payable_id'] === null) {
            $invalidProperties[] = "'payable_id' can't be null";
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling LineItemResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setTotal($total)
    {
        ...
        if (($total < 0)) {
            throw new \InvalidArgumentException('invalid value for $total when calling LineItemResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setTax($tax)
    {
        ...
        if (($tax < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax when calling LineItemResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setSubtotal($subtotal)
    {
        ...
        if (($subtotal < 0)) {
            throw new \InvalidArgumentException('invalid value for $subtotal when calling LineItemResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets payable_id
     *
     * @param string $payable_id payable_id
     *
     * @return self
     */
    public function setPayableId($payable_id)
    {
        if (is_null($payable_id)) {
            throw new \InvalidArgumentException('non-nullable payable_id cannot be null');
        }
