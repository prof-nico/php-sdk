...
/**
 * AddCustomTemplateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddCustomTemplateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddCustomTemplateSchema';
    ...
    */
     ...
     * Sets language_code
     *
     * @param string $language_code Lowercase iso code of language
     *
     * @return self
     */
     ...
     *
     * @param string $subject_template Jinja2 compatible string with email subject
     *
     * @return self
     */
     ...
     * Sets body_template
     *
     * @param string $body_template Jinja2 compatible string with email body
     *
     * @return self
     */
     ...
     * Sets template_name
     *
     * @param string $template_name One of pre-defined names of emails. Should be validated with enum
     *
     * @return self
     */
