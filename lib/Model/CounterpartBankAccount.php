...
/**
 * CounterpartBankAccount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CounterpartBankAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CounterpartBankAccount';
    ...
    */
    ...
    public function setIban($iban)
    {
        ...
        if ((mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling CounterpartBankAccount., must be smaller than or equal to 34.');
        }
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling CounterpartBankAccount., must be smaller than or equal to 11.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CounterpartBankAccount., must be smaller than or equal to 200.');
        }
