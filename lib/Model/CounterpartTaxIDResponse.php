...
/**
 * CounterpartTaxIDResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CounterpartTaxIDResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CounterpartTaxIDResponse';
    ...
    protected static $openAPITypes = [
        'type' => '\OpenAPI\Client\Model\TaxIDTypeEnum',
        'value' => 'string',
        'id' => 'string',
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\TaxIDTypeEnum|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\TaxIDTypeEnum|null $type type
     *
     * @return self
     */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 32)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CounterpartTaxIDResponse., must be smaller than or equal to 32.');
        }
