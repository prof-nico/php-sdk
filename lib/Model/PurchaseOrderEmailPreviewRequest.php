...
/**
 * PurchaseOrderEmailPreviewRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PurchaseOrderEmailPreviewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseOrderEmailPreviewRequest';
    ...
    {
        $this->setIfExists('subject_text', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subject_text'] === null) {
            $invalidProperties[] = "'subject_text' can't be null";
        }
        if ($this->container['body_text'] === null) {
            $invalidProperties[] = "'body_text' can't be null";
        }
    ...
    {
        if (is_null($subject_text)) {
            throw new \InvalidArgumentException('non-nullable subject_text cannot be null');
        }
     ...
     * Sets body_text
     *
     * @param string $body_text body_text
     *
     * @return self
     */
