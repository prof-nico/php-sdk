...
/**
 * MissingLineItemFields Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MissingLineItemFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MissingLineItemFields';
    ...
    {
        $this->setIfExists('line_item_number', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int $line_item_number Order number of line item.
     *
     * @return self
     */
    public function setLineItemNumber($line_item_number)
    {
        if (is_null($line_item_number)) {
            throw new \InvalidArgumentException('non-nullable line_item_number cannot be null');
        }
     ...
     * Sets missing_fields
     *
     * @param string[] $missing_fields Missing fields of line item.
     *
     * @return self
     */
