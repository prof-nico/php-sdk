...
class WebhookUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'object_type' => '\OpenAPI\Client\Model\WebhookObjectType',
        'url' => 'string'
    ];
    ...
    */
     ...
     * Gets object_type
     *
     * @return \OpenAPI\Client\Model\WebhookObjectType|null
     */
     ...
     * Sets object_type
     *
     * @param \OpenAPI\Client\Model\WebhookObjectType|null $object_type object_type
     *
     * @return self
     */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookUpdateRequest., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookUpdateRequest., must be bigger than or equal to 1.');
        }
