...
/**
 * TagReadSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class TagReadSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TagReadSchema';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TagReadSchema., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TagReadSchema., must be bigger than or equal to 1.');
        }
     ...
     * Sets id
     *
     * @param string $id A unique ID of this tag.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Date and time when the tag was created. Timestamps follow the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) standard.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at Date and time when the tag was last updated. Timestamps follow the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) standard.
     *
     * @return self
     */
     ...
     *
     * @param string|null $created_by_entity_user_id ID of the user who created the tag
     *
     * @return self
     */
