...
/**
 * ApprovalRequestResourceWithMetadata Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApprovalRequestResourceWithMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApprovalRequestResourceWithMetadata';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OpenAPI\Client\Model\ApprovalRequestStatus',
        'user_ids' => 'string[]',
        'role_ids' => 'string[]',
        'approved_by' => 'string[]',
        'rejected_by' => 'string',
    ...
    protected static $setters = [
        ...
        'required_approval_count' => 'setRequiredApprovalCount',
        'status' => 'setStatus',
        'user_ids' => 'setUserIds',
        'role_ids' => 'setRoleIds',
    ...
    protected static $getters = [
        ...
        'required_approval_count' => 'getRequiredApprovalCount',
        'status' => 'getStatus',
        'user_ids' => 'getUserIds',
        'role_ids' => 'getRoleIds',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('required_approval_count', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['required_approval_count'] === null) {
            $invalidProperties[] = "'required_approval_count' can't be null";
        }
        if (($this->container['required_approval_count'] < 1)) {
            $invalidProperties[] = "invalid value for 'required_approval_count', must be bigger than or equal to 1.";
        }
    ...
    /**
     * Gets required_approval_count
     *
     * @return int
     */
    public function getRequiredApprovalCount()
    {
        return $this->container['required_approval_count'];
    }

    /**
     * Sets required_approval_count
     *
     * @param int $required_approval_count required_approval_count
     *
     * @return self
     */
    public function setRequiredApprovalCount($required_approval_count)
    {
        if (is_null($required_approval_count)) {
            throw new \InvalidArgumentException('non-nullable required_approval_count cannot be null');
        }

        if (($required_approval_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $required_approval_count when calling ApprovalRequestResourceWithMetadata., must be bigger than or equal to 1.');
        }

        $this->container['required_approval_count'] = $required_approval_count;
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\ApprovalRequestStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\ApprovalRequestStatus $status status
     *
     * @return self
     */
