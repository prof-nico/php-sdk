...
/**
 * ProductServiceRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductServiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductServiceRequest';
    ...
    */
    ...
    public function setSmallestAmount($smallest_amount)
    {
        ...
        if (($smallest_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $smallest_amount when calling ProductServiceRequest., must be bigger than or equal to 0.');
        }
