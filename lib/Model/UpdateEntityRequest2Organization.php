<?php
/**
 * UpdateEntityRequest2Organization
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateEntityRequest2Organization Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateEntityRequest2Organization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateEntityRequest2_organization';
    ...
    */
    ...
    public function setLegalName($legal_name)
    {
        ...
        if ((mb_strlen($legal_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $legal_name when calling UpdateEntityRequest2Organization., must be smaller than or equal to 255.');
        }
    ...
    public function setLegalEntityId($legal_entity_id)
    {
        ...
        if ((mb_strlen($legal_entity_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $legal_entity_id when calling UpdateEntityRequest2Organization., must be smaller than or equal to 20.');
        }
