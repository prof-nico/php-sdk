...
class BankAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling BankAccount., must be smaller than or equal to 11.');
        }
     ...
     * Sets name
     *
     * @param string|null $name Display name of a bank account
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BankAccount., must be smaller than or equal to 200.');
        }
