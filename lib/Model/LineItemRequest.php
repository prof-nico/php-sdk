...
class LineItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling LineItemRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTotal($total)
    {
        ...
        if (($total < 0)) {
            throw new \InvalidArgumentException('invalid value for $total when calling LineItemRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTax($tax)
    {
        ...
        if (($tax < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax when calling LineItemRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setSubtotal($subtotal)
    {
        ...
        if (($subtotal < 0)) {
            throw new \InvalidArgumentException('invalid value for $subtotal when calling LineItemRequest., must be bigger than or equal to 0.');
        }
