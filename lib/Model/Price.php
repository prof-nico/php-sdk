...
class Price implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets value
     *
     * @param int $value The actual price of the product.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling Price., must be bigger than or equal to 0.');
        }
