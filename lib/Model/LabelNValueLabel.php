...
/**
 * LabelNValueLabel Class Doc Comment
 *
 * @category Class
 ...
 */
class LabelNValueLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelNValue_label';
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 100)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling LabelNValueLabel., must be smaller than or equal to 100.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling LabelNValueLabel., must be bigger than or equal to 0.');
        }
