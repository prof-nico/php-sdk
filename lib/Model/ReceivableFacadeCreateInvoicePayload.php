...
/**
 * ReceivableFacadeCreateInvoicePayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReceivableFacadeCreateInvoicePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceivableFacadeCreateInvoicePayload';
    ...
    */
    ...
    public function setCounterpartBusinessType($counterpart_business_type)
    {
        ...
        if ((mb_strlen($counterpart_business_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_business_type when calling ReceivableFacadeCreateInvoicePayload., must be smaller than or equal to 50.');
        }
    ...
    public function setPurchaseOrder($purchase_order)
    {
        ...
        if ((mb_strlen($purchase_order) > 100)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order when calling ReceivableFacadeCreateInvoicePayload., must be smaller than or equal to 100.');
        }
