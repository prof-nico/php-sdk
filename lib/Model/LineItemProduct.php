...
class LineItemProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'vat_rate' => '\OpenAPI\Client\Model\VatRateResponse',
        'measure_unit' => '\OpenAPI\Client\Model\UnitResponse'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['measure_unit'] === null) {
            $invalidProperties[] = "'measure_unit' can't be null";
        }
    ...
    public function setSmallestAmount($smallest_amount)
    {
        ...
        if (($smallest_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $smallest_amount when calling LineItemProduct., must be bigger than or equal to 0.');
        }
     ...
     * Gets vat_rate
     *
     * @return \OpenAPI\Client\Model\VatRateResponse
     */
     ...
     * Sets vat_rate
     *
     * @param \OpenAPI\Client\Model\VatRateResponse $vat_rate vat_rate
     *
     * @return self
     */
     ...
     * Gets measure_unit
     *
     * @return \OpenAPI\Client\Model\UnitResponse
     */
     ...
     * Sets measure_unit
     *
     * @param \OpenAPI\Client\Model\UnitResponse $measure_unit measure_unit
     *
     * @return self
     */
