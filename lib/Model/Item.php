...
class Item implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 100)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling Item., must be smaller than or equal to 100.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling Item., must be bigger than or equal to 0.');
        }
