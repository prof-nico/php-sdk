...
/**
 * InvoiceResponsePayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceResponsePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceResponsePayload';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OpenAPI\Client\Model\ReceivablesStatusEnum',
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the document uploaded.
     *
     * @return self
     */
    ...
    public function setCounterpartBusinessType($counterpart_business_type)
    {
        ...
        if ((mb_strlen($counterpart_business_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_business_type when calling InvoiceResponsePayload., must be smaller than or equal to 50.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\ReceivablesStatusEnum
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\ReceivablesStatusEnum $status status
     *
     * @return self
     */
    ...
    public function setPurchaseOrder($purchase_order)
    {
        ...
        if ((mb_strlen($purchase_order) > 100)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order when calling InvoiceResponsePayload., must be smaller than or equal to 100.');
        }
