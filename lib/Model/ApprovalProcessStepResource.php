...
/**
 * ApprovalProcessStepResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApprovalProcessStepResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApprovalProcessStepResource';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OpenAPI\Client\Model\ApprovalProcessStepStatus',
        'user_ids' => 'string[]',
        'role_ids' => 'string[]',
        'approved_by' => 'string[]',
        'rejected_by' => 'string'
    ...
    */
    ...
    public function setRequiredApprovalCount($required_approval_count)
    {
        ...
        if (($required_approval_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $required_approval_count when calling ApprovalProcessStepResource., must be bigger than or equal to 1.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\ApprovalProcessStepStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\ApprovalProcessStepStatus $status status
     *
     * @return self
     */
