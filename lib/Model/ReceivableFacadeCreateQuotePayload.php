...
/**
 * ReceivableFacadeCreateQuotePayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReceivableFacadeCreateQuotePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceivableFacadeCreateQuotePayload';
    ...
    */
    ...
    public function setQuoteAcceptPageUrl($quote_accept_page_url)
    {
        ...
        if ((mb_strlen($quote_accept_page_url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $quote_accept_page_url when calling ReceivableFacadeCreateQuotePayload., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($quote_accept_page_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $quote_accept_page_url when calling ReceivableFacadeCreateQuotePayload., must be bigger than or equal to 1.');
        }
    ...
    public function setCounterpartBusinessType($counterpart_business_type)
    {
        ...
        if ((mb_strlen($counterpart_business_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_business_type when calling ReceivableFacadeCreateQuotePayload., must be smaller than or equal to 50.');
        }
