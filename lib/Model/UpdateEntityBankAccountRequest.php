...
/**
 * UpdateEntityBankAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateEntityBankAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateEntityBankAccountRequest';
    ...
    */
    ...
    public function setIban($iban)
    {
        ...
        if ((mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling UpdateEntityBankAccountRequest., must be smaller than or equal to 34.');
        }
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling UpdateEntityBankAccountRequest., must be smaller than or equal to 11.');
        }
