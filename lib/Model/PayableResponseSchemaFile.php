...
/**
 * PayableResponseSchemaFile Class Doc Comment
 *
 * @category Class
 ...
 */
class PayableResponseSchemaFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayableResponseSchema_file';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PayableResponseSchemaFile., must be smaller than or equal to 512.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size < 0)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PayableResponseSchemaFile., must be bigger than or equal to 0.');
        }
