...
/**
 * UpdateTodoTask Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTodoTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTodoTask';
    ...
    {
        $this->setIfExists('mute', $data ?? [], false);
        $this->setIfExists('viewed', $data ?? [], false);
    }
