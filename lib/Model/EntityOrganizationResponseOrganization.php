...
/**
 * EntityOrganizationResponseOrganization Class Doc Comment
 *
 * @category Class
 ...
 */
class EntityOrganizationResponseOrganization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntityOrganizationResponse_organization';
    ...
    */
    ...
    public function setLegalName($legal_name)
    {
        ...
        if ((mb_strlen($legal_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $legal_name when calling EntityOrganizationResponseOrganization., must be smaller than or equal to 255.');
        }
    ...
    public function setVatId($vat_id)
    {
        ...
        if ((mb_strlen($vat_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $vat_id when calling EntityOrganizationResponseOrganization., must be smaller than or equal to 15.');
        }
    ...
    public function setLegalEntityId($legal_entity_id)
    {
        ...
        if ((mb_strlen($legal_entity_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $legal_entity_id when calling EntityOrganizationResponseOrganization., must be smaller than or equal to 20.');
        }
