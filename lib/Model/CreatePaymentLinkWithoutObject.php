...
/**
 * CreatePaymentLinkWithoutObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentLinkWithoutObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentLinkWithoutObject';
    ...
    */
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling CreatePaymentLinkWithoutObject., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($return_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling CreatePaymentLinkWithoutObject., must be bigger than or equal to 1.');
        }
