...
/**
 * UpdatePurchaseOrderPayloadSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdatePurchaseOrderPayloadSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePurchaseOrderPayloadSchema';
    ...
    */
     ...
     * Sets counterpart_id
     *
     * @param string|null $counterpart_id Counterpart unique ID.
     *
     * @return self
     */
     ...
     * Sets valid_for_days
     *
     * @param int|null $valid_for_days Number of days for which purchase order is valid
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\PurchaseOrderItem[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\PurchaseOrderItem[]|null $items List of item to purchase
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Msg which will be send to counterpart for who the purchase order is issued.
     *
     * @return self
     */
