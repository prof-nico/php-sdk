 ...
 */
class RootSchema4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RootSchema4';
    ...
    protected static $openAPITypes = [
        'object_type' => 'string',
        'actions' => '\OpenAPI\Client\Model\PayableActionSchema4[]'
    ];
    ...
    public const OBJECT_TYPE_PAYABLE = 'payable';
    ...
    {
        $this->setIfExists('object_type', $data ?? [], 'payable');
        $this->setIfExists('actions', $data ?? [], null);

        // Initialize discriminator property with the model name.
        $this->container['object_type'] = static::$openAPIModelName;
    }
    ...
    */
     ...
     * Gets actions
     *
     * @return \OpenAPI\Client\Model\PayableActionSchema4[]|null
     */
     ...
     * Sets actions
     *
     * @param \OpenAPI\Client\Model\PayableActionSchema4[]|null $actions List of actions
     *
     * @return self
     */
